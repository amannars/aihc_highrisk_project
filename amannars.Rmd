...
Text numerical summary of the texts were generated using `pritamdeka/BioBERT-mnli-snli-scinli-scitail-mednli-stsb` and stored as dense vectors.
...
| Horizon | AUC (higher is better) | Precision | Recall |  F1 Score  |   
|---------|------------------------|-----------|--------|------------|
